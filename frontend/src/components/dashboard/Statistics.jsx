...
//           datasets: [{
//             data: [
//               data.stats.problems_solved_by_difficulty.easy,
//               data.stats.problems_solved_by_difficulty.medium,
//               data.stats.problems_solved_by_difficulty.hard
//             ],
//             backgroundColor: [
...
//     if (data && progressChartRef.current) {
